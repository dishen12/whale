...
train_images,train_labels_id,labels_all = loadTrainData("/nfs/project/whale/")
print("p1")
...
with tf.Session() as sess:
    ...
    for epoch in range(1, total_epochs + 1):
        ...
        for step in range(0, iteration):
            batch_x,batch_y = loadDataBatch(train_images,train_labels_id,batch_size,step)
            print(step)
        ...
        with open('logs.txt', 'a') as f:
            f.write(line)
        f.close()
        saver.save(sess=sess, save_path='./model/Inception_resnet_v2_'+str(epoch)+'.ckpt')
